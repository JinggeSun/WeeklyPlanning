...
public class WebsocketServerEndpoint {
    ...
    public void sendTo(String toId, Message entity, HttpSession session) {
        fromId = entity.getFromUser().getId().toString();
        httpSession = session;
        ...
        for (WebsocketServerEndpoint endpoint : websocketServerEndpoints) {
            try {
                if (toId == null) {
                    ...
                    log.info(entity.getFromUser().getId() + " 推送消息到窗口：" + toId + " ，推送内容：" + entity.getMessage());
